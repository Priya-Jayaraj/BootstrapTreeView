...
$(document).ready(function () {
	...
	var tst = $('.tree-parent').length;
	//alert(tst);
	//$('.tree-parent').parent().prepend("<div class='hitarea'/>");
	
	var tst1 = $('.list-group-item').filter(":last-child:not(ul)").length;
	alert(tst1);
	$('.list-group-item').filter(":last-child:not(ul)").addClass('lastli');
